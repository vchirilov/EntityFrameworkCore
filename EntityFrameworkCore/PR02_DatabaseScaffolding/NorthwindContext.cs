...
namespace PR02_DatabaseScaffolding
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<NumericValue> NumericValues { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=Northwind;Integrated Security=SSPI;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NumericValue>(entity =>
            {
                entity.HasNoKey();
            });
